...
const toggleSnow = document.querySelector("button");

imgWrap.addEventListener("click", animation);

function animation() {
	imgWrap.classList.add("animation");
	setTimeout(() => {
		imgWrap.classList.remove("animation");
	}, 3000);
}

toggleSnow.addEventListener("click", changeText);
...
function changeText() {
	...
	toggleSnow.removeEventListener("click", changeText);
